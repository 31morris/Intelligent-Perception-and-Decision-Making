...
class Stp3Agent(AutoPilot):
    ...
    def create_affine_mat(x1, y1, theta1, x2, y2, theta2):
        ...
        # 使用 cv2.getRotationMatrix2D 生成初始和目標旋轉矩陣
